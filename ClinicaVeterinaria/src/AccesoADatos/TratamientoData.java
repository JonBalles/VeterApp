...
public class TratamientoData {
    ...
    public Tratamiento buscarTratamiento(int id) {
        ...
        String sql = "SELECT idTratamiento, tipoDeTratamiento, descripcion, idMedicamento, importe, importeTotal, activo FROM tratamiento WHERE idTratamiento = ?";
        ...
        try {
            ...
            if (rs.next()) {
                ...
                tratamiento.setImporteTotal(rs.getDouble("importeTotal"));
    ...
    public void guardarTratamiento(Tratamiento trat) {
        String medis = "";
        PreparedStatement ps;
        String sql = "INSERT INTO tratamiento(tipoDeTratamiento, descripcion, idMedicamento, importe, importeTotal, activo) VALUES (?,?,?,?,?,?)";
        try {
            ps = con.prepareStatement(sql);
            ...
            ps.setDouble(5, trat.getImporteTotal());
            System.out.println(trat.getImporteTotal());
            ...
            JOptionPane.showMessageDialog(null, "Ha ocurrido un error en la base de datos al guardar");
        }
    }
    ...
    public void editarTratamiento(Tratamiento trat) {
        String medis = "";
        PreparedStatement ps;
        String sql = "UPDATE tratamiento SET tipoDeTratamiento = ?, descripcion = ?, idMedicamento = ?, importe = ?, importeTotal = ? WHERE idTratamiento=?";
        try {
            ps = con.prepareStatement(sql);
            ps.setString(1, trat.getTipoDeTratamiento());
            ps.setString(2, trat.getDescripcion());
            ...
            JOptionPane.showConfirmDialog(null, "Error en la base de datos al editar");
        }
    ...
    public ArrayList<Tratamiento> listarTratamiento() {
        ...
        String sql = "SELECT idTratamiento, tipoDeTratamiento, descripcion, idMedicamento, importe, importeTotal, activo FROM tratamiento";
        PreparedStatement ps;
