...
public class GestionTratamiento extends javax.swing.JInternalFrame {
    ...
    public GestionTratamiento(Tratamiento trat, JDesktopPane escritorio) {
        ...
        JLPrecioTotal.setText(String.format("%.2f", trat.getImporteTotal()));
 ...
 //               save.setImporteTotal(Double.parseDouble(JLPrecioTotal.getText()));
...
//                t.setImporteTotal(Double.parseDouble(JLPrecioTotal.getText()));
